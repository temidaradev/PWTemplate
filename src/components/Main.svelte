<script>
  ...
  //im leaving these as examples you can change all
  const tools = [
  ...
  <section id="introPage" class="grid grid-cols-1 py-8 sm:py-14">
    ...
    >
      <h2 class="font-semibold text-center text-4xl sm:text-5xl md:text-6xl">
        Hi! I'm <span class="poppins text-violet-400">Your Name</span> <br />
        Wants To Be A
        <span class="poppins text-violet-400">Your Aim</span>
